# usecase2A_prediction-fewshot-qwen-drivelm.py
"""
Use Case 2A: Few-shot prompting for Prediction QA
- 2-shot: 2 example (image, Q, A) pairs prepended before target question
- Examples drawn from training scenes NOT in eval subset
- Evaluates Prediction QA only (weakest category in zero-shot UC1)
"""
...
OUTPUT_JSON = "/home/xzh5180/Research/vlm-mobility/outputs/usecase2A_prediction-fewshot_qwen_drivelm.json"
...
print(f"\n=== Use Case 2A Results ({NUM_SHOTS}-shot, {TARGET_QTYPE}) ===")
print(f"Recall:        {avg_recall:.3f}")
print(f"Hallucination: {avg_halluc:.3f}")
print(f"N={len(valid)}/{len(results)}")

summary = {
    "experiment": "usecase2A_prediction_fewshot",
